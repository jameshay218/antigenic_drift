function [DataX VirusesArray] = tauleap_singlesir_ibm_matrix(EndTime, DataX, Steps, V_bding)
...
global initViruses; %Initial viruses
...
%%for i=1:length(CurrentViruses(:,VirusCol.vid))
%%Beta(:,i) = Viruses(CurrentViruses(i,VirusCol.vid)).beta';
%%end
