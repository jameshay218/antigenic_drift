--27/11/2015--
Create a new package BindingAvidity/binding (version 4)
Still use which can both simulate long term disease epidemics and also single single outbreak with antigenic changes.
Still need to write a document how I control antigenic changes.
