...
subplot(1,2,1); plot(V,B_Trans,'color',cell2mat(colorm(i))); hold on;
end


subplot(1,2,1);
xlabel('binding avidity'); ylabel('probability of successful replication within a host');
subplot(1,2,2);
xlabel('binding avidity'); ylabel('probability of successful infection given a contact');
