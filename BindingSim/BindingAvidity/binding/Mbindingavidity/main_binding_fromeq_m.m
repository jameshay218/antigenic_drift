...
inputFile.filename = 'params_std_reinfect_small.new.dat';
...
initFile = 'dat/20130815/std_adapt_n4/dat_x_eq_ini.mat';
dat = open(initFile);
...
[DataX VirusesArray] = tauleap_singlesir_ibm_matrix(period,DataX,0,0.4); %change from 0.5->0.3
